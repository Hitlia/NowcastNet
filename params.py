...
def get_args():
    ...
    # data params
    parser.add_argument('--data_path', type=str, default='E://NJU-CPOL/data_to_upload')
    ...
    parser.add_argument('--pool_loss_k', type=int, default=4)
    ...
    parser.add_argument('--lr_evo_de', type=float, default=1e-4)
    ...
    parser.add_argument('--experiment', type=str, default='test0906')
